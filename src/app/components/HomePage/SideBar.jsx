...
const SideBar = () => {
  ...
  return (
    <div>
      <button
        type="button"
        className="fixed top-4 left-5 z-50 p-2 text-gray-500 rounded-lg sm:hidden bg-gray-500 shadow-md"
      ...
      <aside
        ...
        <div className="h-full px-3 overflow-y-auto bg-gray-50 dark:bg-gray-800 py-[50px]">
